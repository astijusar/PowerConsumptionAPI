...
namespace PowerConsumptionAPI.Migrations
{
    ...
    [Migration("20230318090608_AddTotalPowerConsumptionToDb")]
    partial class AddTotalPowerConsumptionToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "e90a6274-df4b-4511-a71d-d4f98c0a46db",
                            ConcurrencyStamp = "22177730-4c13-4baa-a7c9-eda32ded1f72",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "e421773b-4247-4133-af99-a19fcc180c69",
                            ConcurrencyStamp = "4aade683-4611-4909-b50e-b82822b637e1",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("PowerConsumptionAPI.Models.PowerConsumption", b =>
                {
                    ...
                    b.Property<float>("TotalPowerDraw")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PowerConsumptionAPI.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PowerConsumptionAPI.Models.User", null)
                        .WithMany()
